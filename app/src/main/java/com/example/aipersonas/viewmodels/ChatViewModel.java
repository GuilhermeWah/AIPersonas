...
public class ChatViewModel extends AndroidViewModel {
    ...
    public ChatViewModel(@NonNull Application application, ChatRepository chatRepository, String personaId, String chatId) {
        super(application);
    ...
    public void saveChat(Chat chat) {
        chatRepository.saveChatToFirestoreAndRoom(chat);
    }
